...
impl BfTree {
    ...
    pub fn new_from_snapshot(bf_tree_config: Config, buffer_ptr: Option<*mut u8>) -> Self {
...
mod tests {
    ...
    fn persist_roundtrip_simple(
        ...
        let bftree = BfTree::with_config(config.clone(), None);
        ...
        let bftree = BfTree::new_from_snapshot(config.clone(), None);
